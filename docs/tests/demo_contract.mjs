...
assert.match(app, /const telemetryPattern = \[/, "deterministic telemetry pattern is missing");
...
console.log("PROMETHEUS demo contract PASS: skip, replay, telemetry, proof and closeout controls verified");
